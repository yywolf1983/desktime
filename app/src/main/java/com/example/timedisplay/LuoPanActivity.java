...
public class LuoPanActivity extends Activity {
    ...
    private String getNayin(String mountain) {
        String[] nayinMap = {
            "海中金", "海中金", "海中金", "涧下水", "涧下水", "涧下水",
            "大溪水", "大溪水", "大溪水", "沙中土", "沙中土", "沙中土",
            "天河水", "天河水", "天河水", "大驿土", "大驿土", "大驿土",
            "剑锋金", "剑锋金", "剑锋金", "山头火", "山头火", "山头火"
        };
        String[] mountains = {
            "壬", "子", "癸", "丑", "艮", "寅",
            "甲", "卯", "乙", "辰", "巽", "巳",
    ...
    private String getJiuxingDesc(String bagua) {
        ...
        String[] starExplain = {
            "主财禄、智慧，利经商、考试、求名，吉则财源广进，贵人相助",
            "主疾病、灾祸，易患脾胃病、皮肤病，凶则久病不愈，家宅不安",
            "主争斗、是非，易招官非、口舌，凶则兄弟不和，邻里纠纷",
            "主文星、学业，利考试、写作、升迁，吉则金榜题名，才华横溢",
            "主大灾、凶煞，最凶之星，易招横祸、血光之灾，宜避不宜犯",
            "主官贵、权力，利从政、升职、诉讼，吉则官运亨通，贵人提携",
            "主盗贼、破财，易招盗窃、火灾，凶则家破人亡，血光之灾",
            "主富贵、田宅，利置业、经商、投资，吉则家业兴旺，财福双收",
            "主喜庆、姻缘，利婚嫁、添丁、名声，吉则喜事连连，名扬四海"
        };
    ...
    private String getBamenDesc(String bagua) {
        ...
        String[] doorExplain = {
            "主休息养生，百事皆宜，利见贵人，吉庆之事",
            "主财禄亨通，谋事得利，经商盈利，最吉之门",
            "主损伤破坏，争斗官非，出行不利，疾病伤灾",
            "主堵塞闭塞，隐藏守静，不宜行动，宜守不宜攻",
            "主景美名声，文书奏章，利考试求名，小有吉凶",
            "主死亡衰败，丧事疾病，百事不宜，最凶之门",
            "主惊恐怪异，口舌是非，官非诉讼，虚惊之事",
            "主开启通达，贵人相助，事业顺利，百事可行"
        };
    ...
    private SpannableString getSummary(String mountain, String bagua, String chaoXiang) {
        ...
        sb.append("\n\n");
        sb.append("【重要提示】\n");
        sb.append("吉位宜开门、设卧室、做书房、设财位；\n");
        sb.append("凶位宜作厨房、储物间、卫生间或杂物间；\n");
        sb.append("装修时宜选用与五行相生的颜色和材料。");
